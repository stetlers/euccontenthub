...
class AWSBlogCrawler:
    ...
    def save_to_dynamodb(self, metadata):
        ...
        try:
            ...
            # Check if item exists and if content or title changed
            # FIX: Previously only checked content, but new posts might be missed if they
            # appear in listings but haven't been crawled yet. Now also check title changes.
            ...
            try:
                ...
                if 'Item' in response:
                    ...
                    # Title check catches posts that were added to listing but not yet crawled
                    ...
                    if old_content != new_content or old_title != new_title:
                        ...
                        if old_title != new_title:
                            print(f"  Title changed - will regenerate summary")
                else:

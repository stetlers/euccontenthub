...
def redirect_to_profile(success, message):
    """Redirect to profile page with verification status"""
    verified_param = 'true' if success else 'false'
    redirect_url = f"https://staging.awseuccontent.com/profile?verified={verified_param}"
